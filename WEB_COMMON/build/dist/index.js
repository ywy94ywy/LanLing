...
var Content = function Content(_ref) {
  ...
  return React__default.createElement("div", {
    ...
    }, type.title), React__default.createElement("div", {
      className: style.bgs
...
var SwitchTheme = (function (_ref2) {
  ...
  return React__default.createElement(_Popover, {
...
var index = (function (_ref) {
  ...
  var _getMenuData = ProLayout.getMenuData(rest.route ? rest.route.routes : []),
      menuData = _getMenuData.menuData;

  var _useState = React.useState(getFlatMenuKeys(menuData)),
      _useState2 = _slicedToArray(_useState, 2),
      openKeys = _useState2[0],
      setOpenKeys = _useState2[1]; // 默认展开所有菜单


  var _useState3 = React.useState(window.localStorage.theme || backgroundData[0].background[0]),
  ...
  }, React__default.createElement(ProLayout__default, _extends({
    headerRender: function headerRender() {
      return React__default.createElement("div", {
        className: style$1.header
      }, theme && React__default.createElement("div", {
        className: style$1.headerTheme
      }, React__default.createElement(SwitchTheme, {
        data: backgroundData,
        setBackground: setBackground
        ...
        type: "skin"
      }), "\u4E3B\u9898\u8BBE\u7F6E"))), React__default.createElement("div", {
        className: style$1.headerContent
      }, React__default.createElement(Left, null)), React__default.createElement("div", {
...
var index$1 = (function (_ref) {
  ...
  return React__default.createElement("div", {
    ...
    return React__default.createElement("span", {
      ...
      type: v.icon
    }), React__default.createElement("span", null, v.title));
  }));
});
...
var index$2 = (function (_ref) {
  ...
  return user ? React__default.createElement("span", {
    className: style$3.userMenu
  }, React__default.createElement(_Popover, {
    overlayClassName: style$3.userMenu,
    content: React__default.createElement(_Menu, null, systems.map(function (v, i) {
...
exports.CardWithTitle = index$3;
exports.SystemsEntry = index$1;
